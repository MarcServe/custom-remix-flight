              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex-1 space-y-4">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-white dark:bg-card flex items-center justify-center shadow-lg animate-float">
                  ...
                  <div>
                    <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight bg-gradient-to-r from-foreground via-primary to-foreground bg-clip-text text-transparent mb-2">
                ...
                <Button size="lg" onClick={() => navigate("/lead-finder")} className="relative h-12 md:h-14 px-6 md:px-8 text-base md:text-lg font-semibold bg-primary hover:bg-primary/90 text-primary-foreground shadow-xl transition-all hover:scale-105 group w-full md:w-auto">
                  <Search className="mr-2 md:mr-3 h-5 w-5 md:h-6 md:w-6 group-hover:rotate-12 transition-transform" />
                  Find Leads Now
          ...
          <Card className="lg:col-span-2 border-2 hover:border-primary/50 transition-all shadow-lg bg-gradient-to-br from-card to-card/50 hover:shadow-primary/10 hover:shadow-xl">
            <div className="p-6">
              ...
              <div className="grid grid-cols-2 gap-2 md:gap-3">
                <Button variant="outline" className="h-auto flex-col items-start p-3 md:p-4 hover:bg-primary/10 hover:border-primary transition-all group hover:shadow-lg hover:shadow-blue-500/20 relative overflow-hidden" onClick={() => navigate("/lead-finder")}>
                  ...
                  <div className="relative w-8 h-8 md:w-10 md:h-10 rounded-lg bg-blue-500/10 flex items-center justify-center mb-2 md:mb-3 group-hover:scale-110 group-hover:rotate-6 transition-all">
                    <Search className="h-4 w-4 md:h-5 md:w-5 text-blue-500" />
                  </div>
                  <span className="relative font-semibold text-xs md:text-sm">Find Leads</span>
                  <span className="relative text-[9px] md:text-[10px] text-muted-foreground mt-1 leading-tight">AI-powered discovery</span>
                </Button>

                <Button variant="outline" className="h-auto flex-col items-start p-3 md:p-4 hover:bg-primary/10 hover:border-primary transition-all group hover:shadow-lg hover:shadow-orange-500/20" onClick={() => navigate("/sequences")}>
                  <div className="w-8 h-8 md:w-10 md:h-10 rounded-lg bg-orange-500/10 flex items-center justify-center mb-2 md:mb-3 group-hover:scale-110 group-hover:rotate-6 transition-all">
                    <Mail className="h-4 w-4 md:h-5 md:w-5 text-orange-500" />
                  </div>
                  <span className="font-semibold text-xs md:text-sm">Sequences</span>
                  <span className="text-[9px] md:text-[10px] text-muted-foreground mt-1 leading-tight">Email automation</span>
                </Button>

                <Button variant="outline" className="h-auto flex-col items-start p-3 md:p-4 hover:bg-primary/10 hover:border-primary transition-all group hover:shadow-lg hover:shadow-purple-500/20" onClick={() => navigate("/companies")}>
                  <div className="w-8 h-8 md:w-10 md:h-10 rounded-lg bg-purple-500/10 flex items-center justify-center mb-2 md:mb-3 group-hover:scale-110 group-hover:rotate-6 transition-all">
                    <Building2 className="h-4 w-4 md:h-5 md:w-5 text-purple-500" />
                  </div>
                  <span className="font-semibold text-xs md:text-sm">Companies</span>
                  <span className="text-[9px] md:text-[10px] text-muted-foreground mt-1 leading-tight">Manage accounts</span>
                </Button>

                <Button variant="outline" className="h-auto flex-col items-start p-3 md:p-4 hover:bg-primary/10 hover:border-primary transition-all group hover:shadow-lg hover:shadow-green-500/20" onClick={() => navigate("/deals")}>
                  <div className="w-8 h-8 md:w-10 md:h-10 rounded-lg bg-green-500/10 flex items-center justify-center mb-2 md:mb-3 group-hover:scale-110 group-hover:rotate-6 transition-all">
                    <DollarSign className="h-4 w-4 md:h-5 md:w-5 text-green-500" />
                  </div>
                  <span className="font-semibold text-xs md:text-sm">Deals</span>
                  <span className="text-[9px] md:text-[10px] text-muted-foreground mt-1 leading-tight">Track pipeline</span>
                </Button>
              </div>
            </div>
          </Card>
