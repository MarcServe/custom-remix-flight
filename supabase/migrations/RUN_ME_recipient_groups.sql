-- Run this in Supabase Dashboard → SQL Editor to create recipient_groups tables.
-- Required for "Save as group" and "Import from group" in Campaigns and Newsletters.
