-- Fix team security functions by removing SET search_path
-- and using fully qualified table names instead

-- Drop and recreate has_team_membership without SET search_path
...
-- Drop and recreate is_team_admin without SET search_path
...
-- Drop and recreate get_user_team_role without SET search_path
